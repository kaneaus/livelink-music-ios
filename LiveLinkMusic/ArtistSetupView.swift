...
struct ArtistSetupView: View {
    ...
    let genres = ["Rock", "Jazz", "Pop", "Hip-Hop", "Classical", "Electronic", "Acoustic/Folk", "Blues", "Indie/Alternative", "Rock (Soft, Acoustic)", "Country", "Reggae", "Singer-Songwriter", "DJ Set"]
    @State private var showArtistWelcome: Bool = false
    
    var body: some View {
        GeometryReader { geometry in
            ZStack(alignment: .topLeading) {
                Group {
                    if showArtistWelcome {
                        ArtistWelcomeScreen(backAction: backAction, nextAction: {
                        ...
                        ScrollView {
                            VStack(spacing: 20) {
                                ...
                                Text("Bio")
                                    ...
                                    .frame(maxWidth: .infinity, alignment: .leading)
                                    .padding(.leading, (geometry.size.width - 350) / 2)
                                TextField("Enter your bio (max 500 characters)", text: $bio)
                                    .font(.custom("Inter-Regular", size: 16))
                                    .padding()
                                    .frame(width: 350)
                                    .background(Color.white)
                                        ...
                                        ForEach(genres, id: \.self) { genre in
                                            Button(action: {
                                                ...
                                                Text(genre)
                                                    ...
                                                    .foregroundColor(selectedGenres.contains(genre) ? .white : .black)
                                                    .padding(.horizontal, 12)
                                                    .padding(.vertical, 6)
                                                    .background(selectedGenres.contains(genre) ? Color(hex: "FF9B00") : Color.gray.opacity(0.1))
                                                    .clipShape(Capsule())
                                            }
                                        }
                                    }
